...
User text: I received my order ahead of schedule and the product was exactly as described.
{"sentiment": "Positive"}

User text: The service was terrible and no one has solved my problem so far.
{"sentiment": "Negative"}

User text: The product is good, but the packaging arrived slightly damaged.
{"sentiment": "Neutral"}

User text: 'I didn't expect much, but I was surprised by the quality!'
{"sentiment": "Positive"}
...
User text: I received my order ahead of schedule and the product was exactly as described.
Response: The customer is satisfied with the delivery speed and the product’s conformity to the description.
{"sentiment": "Positive"}

User text: The service was terrible and no one has solved my problem so far.
Response: The sentence expresses dissatisfaction with the service and frustration at the unresolved problem.
{"sentiment": "Negative"}

User text: The product is good, but the packaging arrived slightly damaged.
Response: Although praising the product, the customer makes a moderate criticism regarding the packaging condition.
{"sentiment": "Neutral"}

User text: I didn’t expect much, but I was pleasantly surprised by the quality!
Response: The author demonstrates positive surprise, indicating the product exceeded expectations.
{"sentiment": "Positive"}
